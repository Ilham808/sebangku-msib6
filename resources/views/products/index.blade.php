                    ...
                    <div
                        ...
                        <div
                            ...
                            <h3
                                ...
                                <span class="mt-1 font-medium text-secondary-dark text-lg/normal">{{ __('All products from your store') }}</span>
                            </h3>
                                ...
                                <table class="w-full my-0 align-middle text-dark border-neutral-200">
                                    ...
                                    <tbody>
                                        <tr class="border-b border-dashed last:border-b-0">
                                            ...
                                            <td class="p-3 pr-0 text-end">
                                                <span
                                                    class="font-semibold text-light-inverse text-md/normal">Active</span>
                                            </td>
                                            <td class="p-3 pr-0 text-end">
                                                <span

    ...
    <div class="text-gray-700">
        <div class="grid md:grid-cols text-sm">
            ...
            <div class="grid grid-cols-2">
                ...
                <div class="px-4 py-2">{{ $user->roles }}</div>
            </div>
...
<a
    ...
    class="block w-full text-white text-sm font-semibold rounded-lg bg-red-400 text-center hover:bg-red-600 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">
    Back
</a>
